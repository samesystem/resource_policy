...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Access controll for single resource and it's methods}
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["changelog_uri"] = "https://github.com/samesystem/resource_policy/blob/v#{ResourcePolicy::VERSION}/CHANGELOG.md"
  else
